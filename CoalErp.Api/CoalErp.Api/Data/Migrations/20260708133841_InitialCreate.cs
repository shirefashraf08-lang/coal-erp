        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditLimit = table.Column<decimal>(type: "TEXT", precision: 18, scale: 3, nullable: false),
                    CurrentBalance = table.Column<decimal>(type: "TEXT", precision: 18, scale: 3, nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WholesalePrice = table.Column<decimal>(type: "TEXT", precision: 18, scale: 3, nullable: false),
                    RetailPrice = table.Column<decimal>(type: "TEXT", precision: 18, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCollected = table.Column<decimal>(type: "TEXT", nullable: false),
                    Notes = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryRoutes_AspNetUsers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TreasuryTransactions_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubTotal = table.Column<decimal>(type: "TEXT", precision: 18, scale: 3, nullable: false),
                    Discount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 3, nullable: false),
                    TotalAmount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 3, nullable: false),
                    PaidAmount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 3, nullable: false),
                    Status = table.Column<string>(type: "TEXT", nullable: false),
                    PaymentType = table.Column<string>(type: "TEXT", nullable: false),
                    Notes = table.Column<string>(type: "TEXT", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryMovements_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseInvoices_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "TEXT", nullable: false),
                    AmountDue = table.Column<decimal>(type: "TEXT", precision: 18, scale: 3, nullable: false),
                    AmountCollected = table.Column<decimal>(type: "TEXT", precision: 18, scale: 3, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeliveryStops_Invoices_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryStopItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeliveryStopItems_DeliveryStops_DeliveryStopId",
                        column: x => x.DeliveryStopId,
                        principalTable: "DeliveryStops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeliveryStopItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryStopItems_DeliveryStopId",
                table: "DeliveryStopItems",
                column: "DeliveryStopId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryStopItems_ProductId",
                table: "DeliveryStopItems",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryStops_InvoiceId",
                table: "DeliveryStops",
                column: "InvoiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreasuryTransactions_CreatedById",
